...
//		sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"").append(StoreUtil.getStoreUrl()).append("css/account.css\" media=\"all\" />");
		...
		sb.append("<a href=\"").append(StoreUtil.getStoreUrl()).append("\" title=\"").append(code.getValue("config_comapny_name")).append("\"><img src=\"").append(StoreUtil.getStoreUrl()).append("image/logo.png\" alt=\"").append(code.getValue("config_comapny_name")).append("\" style=\"margin-bottom: 20px; border: none;\" /></a>");
//		sb.append("<a href=\"\"><img src=\"").append(StoreUtil.getStoreUrl()).append("image/logo.png\" alt=\"").append(code.getValue("config_comapny_name")).append("\" style=\"margin-bottom:20px;border:none;max-width: 100%;height: auto;\"></a>");
