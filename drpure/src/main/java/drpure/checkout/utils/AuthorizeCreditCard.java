...
//        paymentType.set
        ...
        solution.setId(""); // A1000015 - Opencart
        ...
        if (response!=null) {
        	...
        	if (response.getMessages().getResultCode() == MessageTypeEnum.OK) {
        		...
        		if(result.getMessages() != null){
        			...
        			rtnMap.put("avsResultCode", result.getAvsResultCode());
        			
        			System.err.println("Successfully created transaction with Transaction ID: " + result.getTransId());
        			System.err.println("authCode: " + result.getAuthCode());
        			System.err.println("responseCode: " + result.getResponseCode());
        			System.err.println("avsResultCode: " + result.getAvsResultCode());
        			
        		}
        		else {
        			System.err.println("OK-Failed Transaction.");
        			if(response.getTransactionResponse().getErrors() != null){
        				...
        				System.err.println("Error Code: " + response.getTransactionResponse().getErrors().getError().get(0).getErrorCode());
        				System.err.println("Error message: " + response.getTransactionResponse().getErrors().getError().get(0).getErrorText());
        			}
        		}
        	}
        	else {
        		System.err.println("Failed Transaction.");
        		if(response.getTransactionResponse() != null && response.getTransactionResponse().getErrors() != null){
        			...
        			System.err.println("Error Code: " + response.getMessages().getMessage().get(0).getCode());
        			System.err.println("Error message: " + response.getMessages().getMessage().get(0).getText());
        		}
        	}
        }
        else {
...
//		System.err.println("========>AuthorizeCreditCard.runTest()");
		...
		rtnMap.put("authCode", "test");
		rtnMap.put("responseCode", "test");
		rtnMap.put("avsResultCode", "test");
