package drpure.checkout.controller;
...
import drpure.common.constant.Message;
...
import drpure.common.email.OrderEmail;
import drpure.common.util.CustomTag;
import drpure.common.util.DateUtils;
import drpure.common.util.ObjectUtils;
import drpure.common.util.OrderUtils;
...
import drpure.language.CheckoutLanguage;
import drpure.account.service.AccountService;
import drpure.checkout.service.CartService;
import drpure.checkout.service.CheckoutService;
import drpure.checkout.utils.AuthorizeCreditCard;
...
//		String shippingfee_type2 = ObjectUtils.null2Value(commandMap.get("shippingfee_type"),"0");
//		System.err.println(shippingfee_type2);
//		boolean break_yn = true;
//		if(break_yn) {
//			return mv;
//		}
		// 세션 고객 정보
